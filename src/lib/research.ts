...
export const RANDOM_EVENTS = [
  ...
  { type: "positive", name: "Tech Breakthrough", effect: (e: Record<string, number>) => { e.researchPoints = (e.researchPoints || 0) + 100000; return "Research lab breakthrough! +100,000 research points."; } },
