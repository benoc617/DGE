/**
 * @dge/engine — Async semaphores for overlapping AI decisions.
 *
 * Limits concurrent Gemini API calls (RPM) and parallel MCTS CPU work.
 * Caps default from env at module load; `setAiConcurrencyCaps` updates them
 * when SystemSettings is resolved (admin / runtime).
 */
...
/**
 * Updates global Gemini / MCTS concurrency limits.
